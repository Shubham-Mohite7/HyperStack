        ...
        <nav className="flex items-center gap-1">
          ...
          {loading ? (
            ...
            <div className="ml-2 flex items-center gap-2">
              ...
              <button
                onClick={logout}
                className="p-1.5 rounded-lg text-ink-secondary hover:text-ink-primary hover:bg-surface-1 transition-all"
                title="Sign out"
              >
            ...
            <button
              onClick={signIn}
              className="ml-2 px-3 py-1.5 rounded-lg text-[13px] font-medium border border-border-subtle text-ink-secondary hover:text-ink-primary hover:border-border-default transition-all flex items-center gap-2"
            >
